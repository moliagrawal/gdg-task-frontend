            ...
            {sections.map((section, index) => (
                <div key={index} className="flex flex-col items-center space-y-10 w-full">
                    ...
                    <div className="px-10 md:px-20 w-full">
                        ...
                        >
                            {/* Image Section */}
                            <div className="w-full md:w-1/2 p-5 flex justify-center"> {/* Center the image */}
                                <img
                                    src={section.image}
                                    alt={section.title}
                                    className="w-full rounded-md" // Set fixed width to increase size
                                />
                            </div>
                            ...
                            <div className={`w-full md:w-1/2 p-5 ${section.reverseSidebar ? 'border-r-4' : 'border-l-4'} ${section.color} pl-4 ${section.contentAlignment}`}>
                                <p className="text-lg" style={{ fontFamily: 'Google Sans', color: '#5f5f5f', whiteSpace: 'pre-line' }}>
                                    {section.content}
                                </p>
                            </div>
                        </div>
